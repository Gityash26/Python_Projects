...
class Student:
    ...
    def create_manage_frame(self):
        ...
        m_title = Label(self.manage_frame, text="Manage Student", bd=30, font=("Bitter SemiBold", 20, "bold"), bg="#766A9D", fg="Black")
        m_title.grid(row=0, columnspan=2)

        
        # ---- Student roll no.--------------------------------------------------------------------------------------------- 
        Lbl_roll = Label(self.manage_frame, text="Roll No.", bd=5, font=("Bitter SemiBold", 15, "bold"), bg="#766A9D", fg="#2F2446")
        Lbl_roll.grid(row=1, column=0, pady=10, sticky="w")
        
        Txt_roll=Entry(self.manage_frame, textvariable=self.Roll_var, bd=5, font=("Bitter SemiBold", 14), relief=FLAT)
        Txt_roll.grid(row=1, column=1, padx=20, pady=10, sticky="w")


        # ---- Student name ------------------------------------------------------------------------------------------------- 
        Lbl_sName = Label(self.manage_frame, text="Student Name", bd=5, font=("Bitter SemiBold", 15, "bold"), bg="#766A9D", fg="#2F2446")
        Lbl_sName.grid(row=2, column=0, pady=10, sticky="w")
        
        Txt_sName=Entry(self.manage_frame, textvariable=self.Name_var, bd=5, font=("Bitter SemiBold", 14), relief=FLAT)
        Txt_sName.grid(row=2, column=1, padx=20, pady=10, sticky="w")


        # ---- Student DOB ------------------------------------------------------------------------------------------------- 
        Lbl_dob = Label(self.manage_frame, text="DOB", bd=5, font=("Bitter SemiBold", 15, "bold"), bg="#766A9D", fg="#2F2446")
        Lbl_dob.grid(row=3, column=0, pady=10, sticky="w")
        
        Txt_dob=Entry(self.manage_frame, textvariable=self.Dob_var, bd=5, font=("Bitter SemiBold", 14), relief=FLAT)
        Txt_dob.grid(row=3, column=1, padx=20, pady=10, sticky="w")



        # ---- Student Gender ------------------------------------------------------------------------------------------------ 
        Lbl_gen = Label(self.manage_frame, text="Gender", bd=5, font=("Bitter SemiBold", 15, "bold"), bg="#766A9D", fg="#2F2446")
        Lbl_gen.grid(row=4, column=0, pady=10, sticky="w")

        combo_gen = ttk.Combobox(self.manage_frame, textvariable=self.Gender_var, font=("Bitter SemiBold", 13), state="readonly")
        combo_gen['values']=("Male", "Female", "Other")
        combo_gen.grid(row=4, column=1, padx=20, pady=10, sticky="w")


        # ---- Student phone no. ---------------------------------------------------------------------------------------------- 
        Lbl_phone = Label(self.manage_frame, text="Contact", bd=5, font=("Bitter SemiBold", 15, "bold"), bg="#766A9D", fg="#2F2446")
        Lbl_phone.grid(row=5, column=0, pady=10, sticky="w")
        
        Txt_phone=Entry(self.manage_frame, textvariable=self.Contact_var, bd=5, font=("Bitter SemiBold", 14), relief=FLAT)
        ...
        # ---- Student course ---------------------------------------------------------------------------------------------- 
        Lbl_course = Label(self.manage_frame, text="Course", bd=5, font=("Bitter SemiBold", 15, "bold"), bg="#766A9D", fg="#2F2446")
        Lbl_course.grid(row=6, column=0, pady=10, sticky="w")
        
        Txt_course = ttk.Combobox(self.manage_frame, textvariable=self.Course_var, font=("Bitter SemiBold", 13), state="readonly")
        ...
        # ---- Student sem -------------------------------------------------------------------------------------------------- 
        Lbl_sem = Label(self.manage_frame, text="Semester", bd=5, font=("Bitter SemiBold", 15, "bold"), bg="#766A9D", fg="#2F2446")
        Lbl_sem.grid(row=7, column=0, pady=10, sticky="w")
        
        Txt_sem=Entry(self.manage_frame, textvariable=self.Semester_var, bd=5, font=("Bitter SemiBold", 14), relief=FLAT)
        Txt_sem.grid(row=7, column=1, padx=20, pady=10, sticky="w")

        
        # ---- Student email -------------------------------------------------------------------------------------------------- 
        Lbl_email = Label(self.manage_frame, text="Email id", bd=5, font=("Bitter SemiBold", 15, "bold"), bg="#766A9D", fg="#2F2446")
        Lbl_email.grid(row=8, column=0, pady=10, sticky="w")
        
        Txt_email=Entry(self.manage_frame, textvariable=self.Email_var, bd=5, font=("Bitter SemiBold", 14), relief=FLAT)
        Txt_email.grid(row=8, column=1, padx=20, pady=10, sticky="w")


        # ---- Student father name -------------------------------------------------------------------------------------------------- 
        Lbl_fName = Label(self.manage_frame, text="Father Name", bd=5, font=("Bitter SemiBold", 15, "bold"), bg="#766A9D", fg="#2F2446")
        Lbl_fName.grid(row=9, column=0, pady=10, sticky="w")
        
        Txt_fName=Entry(self.manage_frame, textvariable=self.Father_var, bd=5, font=("Bitter SemiBold", 14), relief=FLAT)
        Txt_fName.grid(row=9, column=1, padx=20, pady=10, sticky="w")


        # ---- Student address -------------------------------------------------------------------------------------------------- 
        Lbl_addr = Label(self.manage_frame, text="Address", bd=5, font=("Bitter SemiBold", 15, "bold"), bg="#766A9D", fg="#2F2446")
        Lbl_addr.grid(row=10, column=0, pady=10, sticky="w")
        
        self.Txt_addr=Text(self.manage_frame, width=25, height=4, font=("Bitter SemiBold", 13))
